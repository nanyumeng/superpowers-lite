...
- [ ] **Step 3: Apply the minimal manifest rewrite**
...
- [ ] **Step 4: Update adapter test expectations and verify GREEN**
...
- [ ] **Step 1: Rewrite one branding behavior test and confirm RED**
...
- [ ] **Step 2: Implement the offline visual companion branding**
...
- [ ] **Step 3: Verify GREEN and package behavior**
...
- [ ] **Step 1: Write focused governance files**
...
- [ ] **Step 2: Remove inherited conduct contact safely**
...
- [ ] **Step 3: Verify local links and required statements**
...
- [ ] **Step 1: Rewrite community templates**
...
- [ ] **Step 4: Verify template and install identity**
...
- [ ] **Step 1: Run adapter and runtime suites**
...
- [ ] **Step 2: Run privacy, brand, and repository checks**
...
- [ ] **Step 3: Commit the release surface**
